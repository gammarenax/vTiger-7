...
{strip}
	<style>
		body {
			background: url(layouts/v7/resources/Images/Custom/wall11.jpg);
	...
	<div class="helpLinks">
		<a href="https://www.gammarenax.ch" target="_blank">gammaRenax AG</a> |
		<a href="https://www.clean-soft.ch" target="_blank">clean&soft AG</a> |
		<a href="https://www.fs-shop.ch" target="_blank">FS-Shop</a> |
		<a href="https://gammarenax.ch/de/dienstleistungen/" title="gammaRenax Dienstleistungen" target="_blank">Dienstleistungen</a>
	</div>
	...
	<div class="col-lg-12">
		<div class="col-xs-4 col-sm-offset-1">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/Custom/logo.png">
				<div>
				...
				<div id="loginFormDiv">
					<form class="form-horizontal" method="POST" action="index.php">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue">Einloggen</button><br>
				...
				<div id="forgotPasswordDiv" class="hide">
					<form class="form-horizontal" action="forgotPassword.php" method="POST">
						...
						<div class="group">
							<button type="submit" class="button buttonBlue forgot-submit-btn">Senden</button><br>
							<span>Bitte fügt die nötigen Informationen ein und bestätigt.<a class="forgotPasswordLink pull-right" style="color: #15c;">Zurück</a></span>
						</div>
					</form>
				</div>
			</div>
	...
	<div class="navbar navbar-fixed-bottom" style="padding-right:2em; padding-left:2em;">
				...
				<div class="row-fluid">
					<div class="span6 pull-left">
						<div class="footer-content">
							<small>
								gammaRenax - Facility Services Company © 1985 - {date('Y')}&nbsp;&nbsp;
								<a href="//www.gammarenax.ch" target="_blank">Website</a>&nbsp;|&nbsp;
								<a href="https://www.gammarenax.ch/de/dienstleistungen"
									target="_blank">Dienstleistungen</a>
					...
					<div class="span6 pull-right">
						<div class="pull-right footer-icons">
							...
							<a href="https://www.facebook.com/gammaRenax/"><img src="layouts/v7/resources/Images/Custom/facebook.png" target="_blank"></a>
							&nbsp;
							<a href="https://www.linkedin.com/company/gammarenax"><img src="layouts/v7/resources/Images/Custom/linkedin.png" target="_blank"></a>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		jQuery(document).ready(function () {
			...
			jQuery("footer.app-footer").remove();
