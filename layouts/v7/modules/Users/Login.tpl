...
{assign var="_CustomLoginTemplate" value=vtemplate_path('Login.Custom.tpl', 'Users/Custom')}
					...
					<div id="forgotPasswordDiv" class="hide">
						<form class="form-horizontal" action="forgotPassword.php" method="POST">
							...
							<div class="group">
								...
								<span>Please enter details and submit<a class="forgotPasswordLink pull-right"
										style="color: #15c;">Back</a></span>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="marketingDiv widgetHeight">
						...
						<div>
							...
							<ul class="bxslider">
								...
								<li class="slide">
									...
									{if $BLOCK_DATA.image}
									<div class="col-lg-3" style="min-height: 100px;"><img src="{$BLOCK_DATA.image}"
					...
					<div class="inActiveImgDiv">
						...
						<a href="https://marketplace.vtiger.com/app/listings" target="_blank" style="margin-right: 25px;"><img
								src="layouts/v7/resources/Images/extensionstore.png"
								style="width: 85%; height: 100%; margin-top: 25px;" /></a>
					</div>
					{/if}
				</div>
			</div>
