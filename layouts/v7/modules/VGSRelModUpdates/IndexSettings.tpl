...
<div class="col-sm-12 col-xs-12">
    ...
    <div>
            ...
            <table class="table table-bordered listViewEntriesTable">
                <thead>
                    <tr class="listViewHeaders">
                        ...
                        <th> {vtranslate('Only First Time', $MODULE)} </th>
                ...
                {foreach item=RMU_FIELDS from=$RMU_FIELDS_ARRAY}
                    <tr class="listViewEntries">
                        ...
                        <td class="listViewEntryValue" nowrap> {$RMU_FIELDS.firstcond} </td>
                        <td class="listViewEntryValue" nowrap> <a class="deleteRecordButton" id="{$RMU_FIELDS.id}"><i title="Delete" class="fa fa-trash alignMiddle"></i></a></td>
        ...
        {* License Link - Do not remove *}
        
        <div class="licenseLink" style=" margin-top: 5%;font-size: 90%;text-align: right;">
            {if $IS_VALIDATED eq true}
                <a href="index.php?module={$MODULE}&view=VGSLicenseSettings&parent=Settings">License Information - Deactivate your license</a>
                {/if}
        </div>
