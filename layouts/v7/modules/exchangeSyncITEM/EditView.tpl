											...
											<table width="100%"  border="0" cellspacing="0" cellpadding="5">
												...
												<tr valign="top">
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<input id="e_username" type="text" class="inputElement" name="e_username" value="{$E_USERNAME}" data-validation-engine="validate[required]">
															</div>
														</td>
													</div>
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<input id="e_password" type="password" class="inputElement" name="e_password" value="{$E_PASSWORD}" data-validation-engine="validate[required]">
															</div>
														</td>
													</div>
												</tr>
												<tr>
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<input id="e_calendar" type="text" class="inputElement" name="e_calendar" value="{$E_CALENDAR}" data-validation-engine="validate[required]">
															</div>
														</td>
													</div>
													<div class="control-group">
														...
														<td>
															<div class="controls form-inline">
																...
																<input id="e_daystosync" type="text" class="inputElement form-control" name="e_daystosync" value="{$E_DAYSTOSYNC}"> <label for="e_daystosync">&nbsp;{vtranslate('LBL_DAYS', "exchangeSyncITEM")}</label>
															</div>
														</td>
													</div>
												</tr>
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																...
																<select id="user_status" name="user_status" class="importBox select2">
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																...
																<select name="direction" class="importBox select2" id="new_direction" onchange="checkPriority()">
																	{if $DIRECTION eq "ALL"}
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																...
																{if $DIRECTION eq "ALL"}
																<select name="priority" id="new_priority" class="importBox select2">
																{else}
																<select name="priority" id="new_priority" class="importBox select2" disabled="true">
																{/if}
												...
												<tr valign="top">
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<strong>&nbsp;H: </strong>
																<select name=start_time1 id="start_time1" class="importBox select2 time" >
																	{html_options options=$START_END_TIME_1 selected=$START_TIME_1_SEL }
																</select>
																<strong>&nbsp;m : </strong>
																<select name=start_time2 id="start_time2" class="importBox select2 time">
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<strong>&nbsp;H: </strong>
																<select name=end_time1 id="end_time1" class="importBox select2 time">
																	{html_options options=$START_END_TIME_1 selected=$END_TIME_1_SEL}
																</select>
																<strong>&nbsp;m : </strong>
																<select name=end_time2 id="end_time2" class="importBox select2 time">
												...
												<tr valign="top">
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<select name="eventstatus" id="eventstatus" class="importBox select2" >
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<select name="eventpriority" id="eventpriority" class="importBox select2">
												...
												<tr>
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<select name="handleprivates" id="handleprivates" class="importBox select2">
												...
												<tr>
													...
													<div class="control-group">
														...
														<td>
															<div class="controls">
																<select name="visibility" id="visibility" class="importBox select2">
																<option value="DEFAULT">{vtranslate('LBL_ASINEXCHANGE', "exchangeSyncITEM")}</option>
