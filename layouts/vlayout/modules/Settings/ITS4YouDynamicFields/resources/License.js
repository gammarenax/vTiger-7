...
if (typeof(Settings_ITS4YouDynamicFields_License_Js) == 'undefined') {
    
    Settings_ITS4YouDynamicFields_License_Js = {	
	editLicense : function($type) {
            ...
            url = "index.php?module=ITS4YouDynamicFields&parent=Settings&view=IndexAjax&mode=editLicense&type="+$type+"&key="+license_key;
	...
	*/
	...
	saveLicenseKey : function(form,is_install) {
            ...
            if (is_install) {
                ...
                params = {};
                params.module = "ITS4YouDynamicFields";
    ...
    deactivateLicense: function() {
            ...
            var license_key = jQuery('#license_key_val').val();
            var deactivateActionUrl = 'index.php?module=ITS4YouDynamicFields&parent=Settings&action=License&mode=deactivateLicense&key='+license_key;
    ...
    registerInstallActions : function() {
            ...
            jQuery('#next_button').click(function(e) {
                    window.location.href = "index.php?module=ITS4YouDynamicFields&parent=Settings&view=List";
            });
	},
