...
Vtiger_AdvanceFilter_Js('ITS4YouDynamicFields_AdvanceFilter_Js',{},{
...
Vtiger_Field_Js('ITS4YouDynamicFields_Field_Js',{},{
     ...
     */
    getUi : function() {
        var html = '<input type="text" class="getPopupUi" name="'+ this.getName() +'"  /><input type="hidden" name="valuetype" value="'+this.get('its4youdynamicfields_valuetype')+'" />';
        html = jQuery(html);
...
Vtiger_Date_Field_Js('ITS4YouDynamicFields_Date_Field_Js',{},{
        ...
        if(comparatorSelectedOptionVal.length > 0) {
                if(comparatorSelectedOptionVal == 'between' || comparatorSelectedOptionVal == 'custom'){
                        ...
                        var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validation-engine="validate[funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" data-validator="[{"name":"PositiveNumber"}]">\n\
                                                <input type="hidden" name="valuetype" value="'+this.get('its4youdynamicfields_valuetype')+'" />';
                        return jQuery(html);
...
Vtiger_Date_Field_Js('ITS4YouDynamicFields_Datetime_Field_Js',{},{
	/**
	 * Function to get the user date format
	 */
	getDateFormat : function(){
	...
	getUi : function() {
		...
		if(this._specialDateTimeComparator(comparatorSelectedOptionVal)) {
			var html = '<input name="'+ this.getName() +'" type="text" value="'+this.getValue()+'" data-validator="[{name:PositiveNumber}]"><input type="hidden" name="valuetype" value="'+this.get('its4youdynamicfields_valuetype')+'" />';
			var element = jQuery(html);
		} else {
			var html = '<input type="text" class="getPopupUi date" name="'+ this.getName() +'"  data-date-format="'+ this.getDateFormat() +'"  value="'+  this.getValue() + '" />'+
						'<input type="hidden" name="valuetype" value="'+this.get('its4youdynamicfields_valuetype')+'" />'
...
Vtiger_Currency_Field_Js('ITS4YouDynamicFields_Currency_Field_Js',{},{
	getUi : function() {
...
Vtiger_Time_Field_Js('ITS4YouDynamicFields_Time_Field_Js',{},{
...
Vtiger_Owner_Field_Js('ITS4YouDynamicFields_Owner_Field_Js',{},{
    getUi : function() {
...
/*
Vtiger_Picklist_Field_Js('ITS4YouDynamicFields_Picklist_Field_Js',{},{
