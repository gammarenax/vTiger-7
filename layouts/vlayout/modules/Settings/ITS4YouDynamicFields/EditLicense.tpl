    ...
    <div class="CustomLabelModalContainer">
        <div class="modal-header">
            ...
            {if $TYPE eq "reactivate"}
                    <h3>{vtranslate('LBL_REACTIVATE', $QUALIFIED_MODULE)}</h3>
            {else}
                    <h3>{vtranslate('LBL_ACTIVATE_KEY', $QUALIFIED_MODULE)}</h3>
            {/if}
        </div>
            ...
            <div class="modal-body">
                <div class="row-fluid">
                    <div class="control-group">
                        <label class="muted control-label">{vtranslate('LBL_LICENSE_KEY', $QUALIFIED_MODULE)}</label>
