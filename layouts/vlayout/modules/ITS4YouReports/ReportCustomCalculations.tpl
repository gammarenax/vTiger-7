            ...
            <table class="table table-bordered table-report">
                <tbody>
                    ...
                    <tr style="height:25px">
                        <td class="dvtCellLabel" nowrap width="100%" align="right" colspan="5" ><b>{vtranslate('LBL_CUSTOM_CALCULATION',$MODULE)}</b></td>
                    </tr>
                    <tr style="height:25px">
            ...
            <table class="table table-bordered table-report">
                <thead>
                    <tr class="blockHeader">
                       <th colspan="2">
                        <i class="icon-info-sign"></i>&nbsp;{vtranslate('LBL_CUSTOM_CALCULATION',$MODULE)}<br>
                       </th>
                   </tr>
                </thead>
                <tbody>
                    <tr style="height:25px">
                        <td>
                            <div class="padding1per">
                              <span>
                                {vtranslate('LBL_STEP61_INFO',$MODULE)}
                              </span>
                            </div>
                        </td>
                    </tr>
