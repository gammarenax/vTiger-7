    ...
    <div class="span9">
        <div class="row-fluid">
            ...
            <div style="width:100%;" id='quick_filter_div' name='quick_filter_div' class="paddingTop20">
                ...
                <table class="table table-bordered table-report" id='quickfiltertable_0'>
                    <tr id='quickfilter_0'>
                        <td colspan='5' align='left'>
                            <input type="hidden" name="quick_filters_save" id="quick_filters_save" value="">
                            <select name="quick_filters" id="quick_filters" multiple class="chzn-select span12" >
                            </select>
                        </td>
                    </tr>
                </table>
                ...
                <table class="table table-bordered table-report" id='quickfiltertable_0'>
                    <tr id='quickfilter_0'>
                        <td colspan='5' align='left'>
                            <button type='button' class='btn' style='float:left;' onclick='addQuickFilterRow()'><strong>{vtranslate('LBL_NEW_CONDITION',$MODULE)}</strong></button>
                        </td>
                    </tr>
                </table>
                *}
