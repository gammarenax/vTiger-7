...
{* NEW GRAPHS *}
                    ...
                    <tr style="height:25px">
                        <td class="medium"><label class="pull-right marginRight10px">{vtranslate('LBL_CHART_Position',$MODULE)}</label></td>
                        <td>
                            <select id="chart_position" name="chart_position">
                                <option value="bottom" {if 'bottom' eq $chart_position}selected='selected'{/if}>{vtranslate('LBL_BOTTOM',$MODULE)}</option>
        ...
        <div class="row-fluid">           
            <table class="table table-bordered table-report">
                <thead>
                    <tr class="blockHeader">
                       <th colspan="2">
                        <i class="icon-info-sign"></i>&nbsp;{vtranslate('LBL_GRAPHS',$MODULE)}<br>
                       </th>
                   </tr>
                </thead>
                <tbody>    
                    <tr style="height:25px">
                        <td>
                            <div class="padding1per">
                              <span>
                                {vtranslate('LBL_STEP12_INFO',$MODULE)}
                              </span>
                            </div>
                        </td>
                    </tr>
