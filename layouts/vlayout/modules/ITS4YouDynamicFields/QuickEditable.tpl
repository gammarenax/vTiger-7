...
<div class="modal-header contentsBackground">
    ...
    <h3>{vtranslate('LBL_QUICK_EDITABLE', $SOURCE_MODULE)} {vtranslate($SINGLE_MODULE, $MODULE)}</h3>
</div>
<form class="form-horizontal quickEditView" name="QuickEdit" id="QuickEdit" method="post" action="index.php">
    {if !empty($PICKIST_DEPENDENCY_DATASOURCE)}
        <input type="hidden" name="picklistDependency" value='{Vtiger_Util_Helper::toSafeHTML($PICKIST_DEPENDENCY_DATASOURCE)}' />
    {/if}
    <div class="quickCreateContent QuickEditScroll" style="width:800px;">
