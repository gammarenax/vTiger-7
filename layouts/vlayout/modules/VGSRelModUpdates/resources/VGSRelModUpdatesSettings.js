...
jQuery.Class("VGSRelModUpdates_Js", {}, {
    SourceModuleUpdate: function () {
        jQuery('#module1').on('change', function (e) {
            ...
            var dataUrl = "index.php?module=VGSRelModUpdates&action=getPicklistFields&source_module=" + module1 + "&field_id=" + $(this).attr('name');
                    ...
                    function (data) {
                        ...
                        if (data.success) {
                            ...
                            if (result.result == 'ok') {
                               ...
                               app.registerEventForDatePickerFields(jQuery('.dateField'));
