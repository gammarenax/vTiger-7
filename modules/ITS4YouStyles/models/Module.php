...
class ITS4YouStyles_Module_Model extends Vtiger_Module_Model {
	...
	public function isSummaryViewSupported() {
        ...
        public function addStyles($content, $parentid="", $parentmodule="", $ordering = "desc"){
            ...
            if (count($Related_Records) > 0) {
                ...
                if (empty($content)){
                    ...
                    if ($simple_html_dom_file != "") {
                        require_once($simple_html_dom_file);


                        if ($simple_html_dom_file == "modules/EMAILMaker/resources/classes/simple_html_dom2.php") {
        ...
        private function getSimpleHtmlDomFile() {
            ...
            } elseif(file_exists("modules/PDFMaker/resources/classes/simple_html_dom.php")) {
                return "modules/PDFMaker/resources/classes/simple_html_dom.php";
            } elseif(file_exists("modules/EMAILMaker/resources/classes/simple_html_dom2.php")) {
                return "modules/EMAILMaker/resources/classes/simple_html_dom2.php";  
            } else {
                return "";
            }
        }
