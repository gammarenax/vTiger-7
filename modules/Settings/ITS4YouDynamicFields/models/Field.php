...
class Settings_ITS4YouDynamicFields_Field_Model extends Vtiger_Field_Model {
	...
	public static function getAdvancedFilterOpsByFieldType() {
		return array(
			...
			'currency' => array('equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'is not empty'),
                        'ITS4YouInvoiceCurrency' => array('equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'is not empty'),
                        'ITS4YouLocalCurrency' => array('equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'is not empty'),
			...
			'percentage' => array('equal to', 'less than', 'greater than', 'does not equal', 'less than or equal to', 'greater than or equal to', 'is not empty'),
                        ...
                        'ITS4YouDocumentsFileUpload' => array('is empty', 'is not empty'),
		);
	}
}
