...
class ITS4YouLanguageEditor {

    var $LBL_MODULE_NAME='Language Editor 4 You';
    var $LBL_MODULE_NAME_OLD='Language Editor 4 You';
    ...
    function updateSettings(){
        ...
        $linkto = 'index.php?module=ITS4YouLanguageEditor&parent=Settings&view=List';
