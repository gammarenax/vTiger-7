...
class ITS4YouDynamicFields_Popup_View extends Vtiger_Popup_View {
	...
	public function initializeListViewContents(Vtiger_Request $request, Vtiger_Viewer $viewer) {
        ...
        if ($src_module == "ITS4YouProcessFlow") {

            $ITS4YouProcessFlowRecordModel = Settings_ITS4YouProcessFlow_Record_Model::getInstance($src_record);
            $selectedModule = $ITS4YouProcessFlowRecordModel->getModule();
            $selectedModuleName = $selectedModule->getName();
            $listViewModel->set('sourceModule', $selectedModuleName);
        }
