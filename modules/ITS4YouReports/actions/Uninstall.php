...
class ITS4YouReports_Uninstall_Action extends Settings_Vtiger_Basic_Action {
    ...
    function process(Vtiger_Request $request) {
        ...
        if ($module) {
            ...
            $request->set('key', $ITS4YouReportsModel->GetLicenseKey());

            $ITS4YouReports_License_Action_Model = new ITS4YouReports_License_Action();
            $ITS4YouReports_License_Action_Model->deactivateLicense($request);
