<?php /* Smarty version Smarty-3.1.7, created on 2019-05-14 13:48:27
         compiled from "/home/gammaren/www/crm7.gammarenax.ch/includes/runtime/../../layouts/v7/modules/ITS4YouReports/ReportGrouping.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8482678755cdac72b1e6d93-36465371%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ec2d25350c7a578f07f9aac762e90a464ae0cb98' => 
    array (
      0 => '/home/gammaren/www/crm7.gammarenax.ch/includes/runtime/../../layouts/v7/modules/ITS4YouReports/ReportGrouping.tpl',
      1 => 1557319797,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8482678755cdac72b1e6d93-36465371',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cdac72b2626a',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cdac72b2626a')) {function content_5cdac72b2626a($_smarty_tpl) {?>
...
</div></div></div></div><div class="row" id="group2_table_row"><div class="form-group"><div class="col-lg-2"><select class="select2 col-lg-12 inputElement" name="timeline_type2" id="timeline_type2" readonly style="float:left;width:7em;margin:auto;" ><?php if ($_smarty_tpl->tpl_vars['REPORTTYPE']->value!="summaries_matrix"){?><option value="rows" <?php if ($_smarty_tpl->tpl_vars['timeline_type2']->value=="rows"){?>selected="selected"<?php }?> ><?php echo vtranslate('LBL_ROWS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option><?php if ($_smarty_tpl->tpl_vars['REPORTTYPE']->value!="summaries_matrix"){?><option value="cols" <?php if ($_smarty_tpl->tpl_vars['timeline_type3']->value=="cols"){?>selected="selected"<?php }?> ><?php echo vtranslate('LBL_COLS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
