<?php /* Smarty version Smarty-3.1.7, created on 2019-05-14 13:48:28
         compiled from "/home/gammaren/www/crm7.gammarenax.ch/includes/runtime/../../layouts/v7/modules/ITS4YouReports/ReportGraphs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:969545835cdac72c451ed7-00217424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a3e369174e2ee4ab46de4f2cf16449c6fe87e112' => 
    array (
      0 => '/home/gammaren/www/crm7.gammarenax.ch/includes/runtime/../../layouts/v7/modules/ITS4YouReports/ReportGraphs.tpl',
      1 => 1557319797,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '969545835cdac72c451ed7-00217424',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5cdac72c4b5ba',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5cdac72c4b5ba')) {function content_5cdac72c4b5ba($_smarty_tpl) {?>
...
</option><?php } ?></select></div></div><div class="form-group"><label class="control-label textAlignLeft col-lg-2"><?php echo vtranslate('Graph1',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><div class="col-lg-2"><?php $_smarty_tpl->tpl_vars["chtype1"] = new Smarty_variable($_smarty_tpl->tpl_vars['CHARTS_ARRAY']->value[1]['charttype'], null, 0);?><select class="select2 inputElement" id="chartType1" name="chartType1"><option value="none"><?php echo getTranslatedString('LBL_NONE','ITS4YouReports');?>
...
</option><?php } ?></select></div></div><div class="form-group"><label class="control-label textAlignLeft col-lg-2"><?php echo vtranslate('Graph2',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><div class="col-lg-2"><?php $_smarty_tpl->tpl_vars["chtype2"] = new Smarty_variable($_smarty_tpl->tpl_vars['CHARTS_ARRAY']->value[2]['charttype'], null, 0);?><select class="select2 inputElement" id="chartType2" name="chartType2"><option value="none"><?php echo getTranslatedString('LBL_NONE','ITS4YouReports');?>
</option><?php  $_smarty_tpl->tpl_vars['charttype_arr'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['charttype_arr']->_loop = false;
 $_smarty_tpl->tpl_vars['chart_type_key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['CHART_TYPE']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['charttype_arr']->key => $_smarty_tpl->tpl_vars['charttype_arr']->value){
...
</option><?php } ?></select></div></div><div class="form-group"><label class="control-label textAlignLeft col-lg-2"><?php echo vtranslate('Graph3',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label><div class="col-lg-2"><?php $_smarty_tpl->tpl_vars["chtype3"] = new Smarty_variable($_smarty_tpl->tpl_vars['CHARTS_ARRAY']->value[3]['charttype'], null, 0);?><select class="select2 inputElement" id="chartType3" name="chartType3"><option value="none"><?php echo getTranslatedString('LBL_NONE','ITS4YouReports');?>
</option><?php  $_smarty_tpl->tpl_vars['charttype_arr'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['charttype_arr']->_loop = false;
 $_smarty_tpl->tpl_vars['chart_type_key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['CHART_TYPE']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['charttype_arr']->key => $_smarty_tpl->tpl_vars['charttype_arr']->value){
