<?php /* Smarty version Smarty-3.1.7, created on 2017-10-24 11:07:30
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/PDFMaker/Edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:117998587759ef1ef2dc3f67-88139705%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4ff01f0cd719f54d4277d2fa45be299764fde005' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/PDFMaker/Edit.tpl',
      1 => 1505402768,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '117998587759ef1ef2dc3f67-88139705',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59ef1ef31aaf5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59ef1ef31aaf5')) {function content_59ef1ef31aaf5($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/home/gammaren/www/crm6.gammarenax.ch/libraries/Smarty/libs/plugins/function.html_options.php';
?>
...
<?php }?>';"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
        ...
        <div id="edit-template-header_content" class="edit-template-header_content row-fluid">
            <div class="span10" style="position:fixed;z-index:1000;">
                <div class="modal-body tabbable" style="padding:0px;background-color:#ffffff">
                     <ul class="nav nav-tabs massEditTabs" style="margin-bottom:0px; padding-left:5px;">
                         <li class="active" id="properties_tab" onclick="PDFMaker_EditJs.showHideTab('properties');"><a data-toggle="tab" href="#properties_div"><?php echo vtranslate('LBL_PROPERTIES_TAB','PDFMaker');?>
</a></li>
...
" class="detailedViewTextBox span5" tabindex="2">
                        ...
                        <tr>
                            <td class="fieldLabel">
                                <label class="muted pull-right marginRight10px"><?php if ($_smarty_tpl->tpl_vars['TEMPLATEID']->value==''){?><span class="redColor">*</span><?php }?><?php echo vtranslate('LBL_MODULENAMES','PDFMaker');?>
:</label></td>
...
:</label></td>
       ...
       <ul class="nav nav-tabs massEditTabs" style="margin-bottom: 0;border-bottom: 0;padding-left:5px;">    
            ...
            <?php if ($_smarty_tpl->tpl_vars['ITS4YOUSTYLE_FILES']->value!=''){?>
                <li onclick="PDFMaker_EditJs.showHideTab3('css_style');">
...
jQuery(document).ready(function() {
    ...
    var $el = jQuery('#edit-template-header_content>div');
    var $window = jQuery(window);

    var announcement = jQuery('#announcement_val').val();
