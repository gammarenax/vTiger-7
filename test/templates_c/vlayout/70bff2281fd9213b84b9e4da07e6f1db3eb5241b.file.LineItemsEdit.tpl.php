<?php /* Smarty version Smarty-3.1.7, created on 2017-10-21 15:32:37
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/GreenTimeControl/LineItemsEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:140177224759eb6895231a36-29411415%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70bff2281fd9213b84b9e4da07e6f1db3eb5241b' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/GreenTimeControl/LineItemsEdit.tpl',
      1 => 1508597451,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '140177224759eb6895231a36-29411415',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59eb68953a7ec',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59eb68953a7ec')) {function content_59eb68953a7ec($_smarty_tpl) {?>
...
" /><table class="table table-bordered blockContainer lineItemTable <?php if (!$_smarty_tpl->tpl_vars['LINEITEM_ISACTIVE']->value){?> hide <?php }?> lineItemIsHide" id="lineItemTab"><tr><th colspan="2"><span class="inventoryLineItemHeader"><?php echo vtranslate('LBL_ITEM_DETAILS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</b></td></tr><tr id="row0" class="hide lineItemCloneCopy"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContent.tpl",'GreenTimeControl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>0,'data'=>array()), 0);?>
...
<?php }?>><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContent.tpl",'GreenTimeControl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>$_smarty_tpl->tpl_vars['row_no']->value,'data'=>$_smarty_tpl->tpl_vars['data']->value), 0);?>
</tr><?php } ?><?php if (count($_smarty_tpl->tpl_vars['RELATED_PRODUCTS']->value)==0){?><tr id="row1" class="lineItemRow"><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path("LineItemsContent.tpl",'GreenTimeControl'), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('row_no'=>1,'data'=>array()), 0);?>
</tr><?php }?></table><div class="row-fluid verticalBottomSpacing <?php if (!$_smarty_tpl->tpl_vars['LINEITEM_ISACTIVE']->value){?> hide <?php }?> lineItemIsHide"><div><?php if ($_smarty_tpl->tpl_vars['PRODUCT_ACTIVE']->value=='true'&&$_smarty_tpl->tpl_vars['SERVICE_ACTIVE']->value=='true'){?><div class="btn-toolbar"><span class="btn-group"><button type="button" class="btn addButton" id="addProduct"><i class="icon-plus"></i><strong><?php echo vtranslate('LBL_ADD_PRODUCT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</strong></button></div><?php }?></div></div><table class="table table-bordered blockContainer lineItemTable <?php if (!$_smarty_tpl->tpl_vars['LINEITEM_ISACTIVE']->value){?> hide <?php }?> lineItemIsHide" id="lineItemResult"><tr><td  width="83%"><div class="pull-right"><strong><?php echo vtranslate('LBL_ITEMS_TOTAL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
