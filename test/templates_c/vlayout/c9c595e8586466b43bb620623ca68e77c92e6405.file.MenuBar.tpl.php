<?php /* Smarty version Smarty-3.1.7, created on 2018-01-22 08:51:24
         compiled from "/home/gammaren/www/crm.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4520442985a0b5adba3b9e5-04501520%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c9c595e8586466b43bb620623ca68e77c92e6405' => 
    array (
      0 => '/home/gammaren/www/crm.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl',
      1 => 1516611030,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4520442985a0b5adba3b9e5-04501520',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5a0b5adbd125f',
  'variables' => 
  array (
    'MENU_STRUCTURE' => 0,
    'moreMenus' => 0,
...
<?php if ($_valid && !is_callable('content_5a0b5adbd125f')) {function content_5a0b5adbd125f($_smarty_tpl) {?>
<script>
function goBack() {
    window.history.back();
}
...
</strong></a></li><?php } ?></ul><button onclick="goBack()" style="background-color: red !important; color:#ffffff; margin-right:20px; margin-top:auto; margin-right:auto; padding:10px; 15px; 10px; 15px; float:right; text-align: center; border:none; text-decoration: none;">Zurück</button><ul class="nav" id="shortNav"><li class="tabs"><a class="alignMiddle <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Home'){?> selected <?php }?>" href="<?php echo $_smarty_tpl->tpl_vars['HOME_MODULE_MODEL']->value->getDefaultUrl();?>
"><img src="<?php echo vimage_path('home.png');?>
" alt="<?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['moduleName']->value);?>
" title="<?php echo vtranslate('LBL_HOME',$_smarty_tpl->tpl_vars['moduleName']->value);?>
