<?php /* Smarty version Smarty-3.1.7, created on 2017-09-20 12:21:09
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/EMAILMaker/ProductBlocks.tpl" */ ?>
<?php /*%%SmartyHeaderCode:129814442859c25d35604782-86366674%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e1162657835dfc3c825cc03b579693da148ee510' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/EMAILMaker/ProductBlocks.tpl',
      1 => 1505401257,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '129814442859c25d35604782-86366674',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c25d3562fde',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c25d3562fde')) {function content_59c25d3562fde($_smarty_tpl) {?>
<div class="container-fluid" id="ProductBlocksContainer">
    ...
    <br>
    <label class="pull-left themeTextColor font-x-x-large"><?php echo vtranslate('LBL_PRODUCTBLOCKTPL','EMAILMaker');?>
</label>
    <br clear="all"><?php echo vtranslate('LBL_PRODUCTBLOCKTPL_DESC','EMAILMaker');?>

    <hr>
    <br />
    <div class="row-fluid">
        <label class="fieldLabel"><strong><?php echo vtranslate('LBL_DEFINE_PBTPL','EMAILMaker');?>
:</strong></label><br>    
        <div class="row-fluid">           
            <button type="button" class="btn btn-danger span1 marginLeftZero" onclick="confirm_delete();"><?php echo vtranslate('LBL_DELETE');?>
</button>    
            <div class="pull-right btn-group">
                <button type="submit" class="addProductBlock btn addButton marginLeftZero" data-url="?module=EMAILMaker&view=IndexAjax&mode=editProductBlock"><i class="icon-plus icon-white"></i>&nbsp;<strong> <?php echo vtranslate('LBL_ADD');?>
</strong></button>
        ...
        <div class="pushDownHalfper">    
            ...
            <thead>
                <tr class="blockHeader">
                    ...
                    <th style="border-left: 1px solid #DDD !important;" width="250px"><?php echo vtranslate('LBL_EMAIL_NAME','EMAILMaker');?>
</th>
                    <th style="border-left: 1px solid #DDD !important;" id="bodyColumn"><?php echo vtranslate('LBL_BODY','EMAILMaker');?>
</th>
...
"/>
                    ...
                    <td><?php echo $_smarty_tpl->tpl_vars['tpl_value']->value['name'];?>
</td>
                    <td>
...
';this.form.mode.value='duplicate'"><?php echo vtranslate('LBL_DUPLICATE','EMAILMaker');?>
</button>
                            </div>
                        </div>
                    </td>
...
?>
                <tr id="noItemFountTr">
                    <td colspan="4" class="cellText" align="center" style="padding:10px;"><strong><?php echo vtranslate('LBL_NO_ITEM_FOUND','EMAILMaker');?>
</strong></td>
                </tr>
            <?php } ?>
            </tbody>
