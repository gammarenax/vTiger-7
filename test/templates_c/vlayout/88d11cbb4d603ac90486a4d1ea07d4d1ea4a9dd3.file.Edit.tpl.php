<?php /* Smarty version Smarty-3.1.7, created on 2018-02-01 14:54:38
         compiled from "/home/gammaren/www/crm.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/LangManagement/Edit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10229112755a732a2e201589-04420609%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '88d11cbb4d603ac90486a4d1ea07d4d1ea4a9dd3' => 
    array (
      0 => '/home/gammaren/www/crm.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/LangManagement/Edit.tpl',
      1 => 1517496866,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10229112755a732a2e201589-04420609',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a732a2e2c0c0',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a732a2e2c0c0')) {function content_5a732a2e2c0c0($_smarty_tpl) {?>
<div class="row-fluid">
	<div class="span4 marginLeftZero">
		<div class="pull-left pushDown2per marginLeftZero" ><?php echo vtranslate('Language',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</div>
		<div class="pull-left">
			<select multiple="multiple" class="chzn-select span4" id="langs_list" style="width:180px">
...
" <?php if ($_smarty_tpl->tpl_vars['ID']->value==$_smarty_tpl->tpl_vars['REQUEST']->value->get('mod')){?>selected<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['MOD']->value,$_smarty_tpl->tpl_vars['MOD']->value);?>
	...
	<div class="span2 marginLeftZero" >
		<input type="checkbox" class="show_differences" name="show_differences" <?php if ($_smarty_tpl->tpl_vars['SD']->value==1){?>checked<?php }?> value="1">&nbsp;<?php echo vtranslate('LBL_SHOW_MISSING_TRANSLATIONS',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
" 
								class="translation <?php if ($_smarty_tpl->tpl_vars['item']->value==null){?>empty_value<?php }?>" 
