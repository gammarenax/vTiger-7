<?php /* Smarty version Smarty-3.1.7, created on 2017-10-13 08:10:19
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/VDSimplyKPI/AdvanceFilter.tpl" */ ?>
<?php /*%%SmartyHeaderCode:80077107359e074ebe0a237-46264255%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9281cc894b030dc28e2913ca3b63dd885ffdd5a' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/VDSimplyKPI/AdvanceFilter.tpl',
      1 => 1507881194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '80077107359e074ebe0a237-46264255',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e074ebec6cf',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e074ebec6cf')) {function content_59e074ebec6cf($_smarty_tpl) {?>
...
?><?php echo $_smarty_tpl->getSubTemplate ('modules/VDSimplyKPI/AdvanceFilterCondition.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'CONDITION_INFO'=>$_smarty_tpl->tpl_vars['CONDITION_INFO']->value,'MODULE'=>$_smarty_tpl->tpl_vars['MODULE']->value), 0);?>
<?php } ?><?php if (count($_smarty_tpl->tpl_vars['ALL_CONDITION_CRITERIA']->value)==0){?><?php echo $_smarty_tpl->getSubTemplate ('modules/VDSimplyKPI/AdvanceFilterCondition.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'MODULE'=>$_smarty_tpl->tpl_vars['MODULE']->value,'CONDITION_INFO'=>array()), 0);?>
<?php }?></div><div class="hide basic"><?php echo $_smarty_tpl->getSubTemplate ('modules/VDSimplyKPI/AdvanceFilterCondition.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'CONDITION_INFO'=>array(),'MODULE'=>$_smarty_tpl->tpl_vars['MODULE']->value,'NOCHOSEN'=>true), 0);?>
</div><?php if ($_smarty_tpl->tpl_vars['MODE']->value!='edit'){?><div class="addCondition"><button type="button" class="btn"><strong><?php echo vtranslate('LBL_ADD_CONDITION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div><?php }?><div class="groupCondition"><?php $_smarty_tpl->tpl_vars['GROUP_CONDITION'] = new Smarty_variable($_smarty_tpl->tpl_vars['ALL_CONDITION_CRITERIA']->value['condition'], null, 0);?><?php if (empty($_smarty_tpl->tpl_vars['GROUP_CONDITION']->value)){?><?php $_smarty_tpl->tpl_vars['GROUP_CONDITION'] = new Smarty_variable("and", null, 0);?><?php }?><input type="hidden" name="condition" value="<?php echo $_smarty_tpl->tpl_vars['GROUP_CONDITION']->value;?>
...
foreach ($_from as $_smarty_tpl->tpl_vars['CONDITION_INFO']->key => $_smarty_tpl->tpl_vars['CONDITION_INFO']->value){
$_smarty_tpl->tpl_vars['CONDITION_INFO']->_loop = true;
?><?php echo $_smarty_tpl->getSubTemplate ('modules/VDSimplyKPI/AdvanceFilterCondition.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'CONDITION_INFO'=>$_smarty_tpl->tpl_vars['CONDITION_INFO']->value,'MODULE'=>$_smarty_tpl->tpl_vars['MODULE']->value,'CONDITION'=>"or"), 0);?>
<?php } ?><?php if (count($_smarty_tpl->tpl_vars['ANY_CONDITION_CRITERIA']->value)==0){?><?php echo $_smarty_tpl->getSubTemplate ('modules/VDSimplyKPI/AdvanceFilterCondition.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'MODULE'=>$_smarty_tpl->tpl_vars['MODULE']->value,'CONDITION_INFO'=>array(),'CONDITION'=>"or"), 0);?>
<?php }?></div><div class="hide basic"><?php echo $_smarty_tpl->getSubTemplate ('modules/VDSimplyKPI/AdvanceFilterCondition.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('RECORD_STRUCTURE'=>$_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value,'MODULE'=>$_smarty_tpl->tpl_vars['MODULE']->value,'CONDITION_INFO'=>array(),'CONDITION'=>"or",'NOCHOSEN'=>true), 0);?>
</div><?php if ($_smarty_tpl->tpl_vars['MODE']->value!='edit'){?><div class="addCondition"><button type="button" class="btn"><strong><?php echo vtranslate('LBL_ADD_CONDITION',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button></div><?php }?></div></div></div><?php }} ?>