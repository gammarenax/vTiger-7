<?php /* Smarty version Smarty-3.1.7, created on 2018-01-16 10:51:02
         compiled from "/home/gammaren/www/crm.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/GreenTimeControl/CalendarSharedUsers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6247056205a5dd916579bc7-21055722%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c8efb509a9d271e168c02ceeb4e9089e2f75862' => 
    array (
      0 => '/home/gammaren/www/crm.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/GreenTimeControl/CalendarSharedUsers.tpl',
      1 => 1516099829,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6247056205a5dd916579bc7-21055722',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a5dd9166110f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a5dd9166110f')) {function content_5a5dd9166110f($_smarty_tpl) {?>
...
"></i></label></div><input type="hidden" class="sharedUsersInfo" value= <?php echo Zend_Json::encode($_smarty_tpl->tpl_vars['SHAREDUSERS_INFO']->value);?>
 /><label class="checkbox addedCalendars" style="text-shadow: none"><input type="checkbox" data-calendar-sourcekey="GreenTimeControl33_<?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_ID']->value;?>
" data-calendar-feed="GreenTimeControl"data-calendar-userid="<?php echo $_smarty_tpl->tpl_vars['CURRENT_USER_ID']->value;?>
...
?><?php if ($_smarty_tpl->tpl_vars['SHAREDUSERS_INFO']->value[$_smarty_tpl->tpl_vars['ID']->value]['visible']!='0'){?><label class="checkbox addedCalendars"><input type="checkbox" data-calendar-sourcekey="GreenTimeControl33_<?php echo $_smarty_tpl->tpl_vars['ID']->value;?>
" data-calendar-feed="GreenTimeControl" data-calendar-userid="<?php echo $_smarty_tpl->tpl_vars['ID']->value;?>
...
<script type="text/javascript">
    jQuery(document).ready(function () {
        SharedCalendar_SharedCalendarViewHelper_Js.initiateCalendarFeeds();
    });
</script><?php }} ?>