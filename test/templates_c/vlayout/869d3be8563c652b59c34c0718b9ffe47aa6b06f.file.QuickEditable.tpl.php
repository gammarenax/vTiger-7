<?php /* Smarty version Smarty-3.1.7, created on 2017-09-18 18:02:07
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/ITS4YouDynamicFields/QuickEditable.tpl" */ ?>
<?php /*%%SmartyHeaderCode:210455468359c00a1fee5c01-54047299%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '869d3be8563c652b59c34c0718b9ffe47aa6b06f' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/ITS4YouDynamicFields/QuickEditable.tpl',
      1 => 1505485622,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '210455468359c00a1fee5c01-54047299',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c00a200b7f1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c00a200b7f1')) {function content_59c00a200b7f1($_smarty_tpl) {?>
...
">x</button><h3><?php echo vtranslate('LBL_QUICK_EDITABLE',$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
 <?php echo vtranslate($_smarty_tpl->tpl_vars['SINGLE_MODULE']->value,$_smarty_tpl->tpl_vars['MODULE']->value);?>
</h3></div><form class="form-horizontal quickEditView" name="QuickEdit" id="QuickEdit" method="post" action="index.php"><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
' /><?php }?><div class="quickCreateContent QuickEditScroll" style="width:800px;"><div class="modal-body"><?php  $_smarty_tpl->tpl_vars['BLOCK_FIELDS'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BLOCK_FIELDS']->_loop = false;
...
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['blockfields']['last']==true&&count($_smarty_tpl->tpl_vars['BLOCK_FIELDS']->value)!=1&&$_smarty_tpl->tpl_vars['COUNTER']->value==1){?><td class="fieldLabel"></td><td></td><?php }?><?php } ?></tr></table><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['QuickViewBlockLevelLoop']['last']!=true){?><br><?php }?><?php } ?></div></div><div class="modal-footer quickCreateActions"><?php $_smarty_tpl->tpl_vars["EDIT_VIEW_URL"] = new Smarty_variable($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getCreateRecordUrl(), null, 0);?><a class="cancelLink cancelLinkContainer pull-right" type="reset" data-dismiss="modal"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
