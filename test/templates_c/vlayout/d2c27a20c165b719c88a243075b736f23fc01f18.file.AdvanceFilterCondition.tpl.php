<?php /* Smarty version Smarty-3.1.7, created on 2017-10-13 08:10:19
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/VDSimplyKPI/AdvanceFilterCondition.tpl" */ ?>
<?php /*%%SmartyHeaderCode:52431681259e074ebee95e5-91689575%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd2c27a20c165b719c88a243075b736f23fc01f18' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/VDSimplyKPI/AdvanceFilterCondition.tpl',
      1 => 1507881194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '52431681259e074ebee95e5-91689575',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e074ec0e35e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e074ec0e35e')) {function content_59e074ec0e35e($_smarty_tpl) {?>
<div class="row-fluid conditionRow marginBottom10px"><span class="span4"><select <?php if ($_smarty_tpl->tpl_vars['MODE']->value=='edit'){?>disabled <?php }?> class="<?php if (empty($_smarty_tpl->tpl_vars['NOCHOSEN']->value)){?>chzn-select<?php }?> row-fluid" name="columnname" ><option value="none"><?php echo vtranslate('LBL_SELECT_FIELD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
<?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
<?php }?></option><?php } ?></optgroup><?php } ?></select></span><span class="span3"><select <?php if ($_smarty_tpl->tpl_vars['MODE']->value=='edit'){?>disabled <?php }?> class="<?php if (empty($_smarty_tpl->tpl_vars['NOCHOSEN']->value)){?>chzn-select<?php }?> row-fluid" name="comparator"><option value="none"><?php echo vtranslate('LBL_NONE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</option><?php } ?></select></span><span class="span4 fieldUiHolder"><input <?php if ($_smarty_tpl->tpl_vars['MODE']->value=='edit'){?>disabled <?php }?> name="<?php if ($_smarty_tpl->tpl_vars['SELECTED_FIELD_MODEL']->value){?><?php echo $_smarty_tpl->tpl_vars['SELECTED_FIELD_MODEL']->value->get('name');?>
...
" /></span><?php if ($_smarty_tpl->tpl_vars['MODE']->value!='edit'){?><span class="span1"><i class="deleteCondition icon-trash alignMiddle" title="<?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></i></span><?php }?></div><?php }} ?>