<?php /* Smarty version Smarty-3.1.7, created on 2017-10-13 08:12:44
         compiled from "/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/VDSimplyKPI/DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:103473372259e0757c47d5e2-55419981%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c5f29d470b0e0b59630419b611c34190bd2097d1' => 
    array (
      0 => '/home/gammaren/www/crm6.gammarenax.ch/includes/runtime/../../layouts/vlayout/modules/VDSimplyKPI/DetailViewBlockView.tpl',
      1 => 1507881194,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '103473372259e0757c47d5e2-55419981',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59e0757c63b36',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59e0757c63b36')) {function content_59e0757c63b36($_smarty_tpl) {?>
...
?><?php if (!$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isViewableInDetailView()){?><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_NAME']->value=='advanced_filter'||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='netto'||$_smarty_tpl->tpl_vars['FIELD_NAME']->value=='datafields'){?><?php continue 1?><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')=="83"){?><?php  $_smarty_tpl->tpl_vars['tax'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['tax']->_loop = false;
...
</span></td><?php }?><?php if (count($_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->value)==1&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="19"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="20"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="30"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('name')!="recurringtype"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="69"&&$_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype')!="105"){?><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"></td><td class="<?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
